...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.action_btn1.setShortcut(Qt.CTRL + Qt.Key_P)
        # self.action_btn1.setShortcut(QKeySequence("Ctrl+p"))
        ...
        self.file_menu.addAction(self.action_btn1)
        self.file_menu.addSeparator()
        self.file_sub_menu = self.file_menu.addMenu("Sub Menu")
        self.file_sub_menu.addAction(self.action_btn2)
        self.file_sub_menu.addAction(self.action_btn1)
        self.file_menu.addSeparator()
        self.file_menu.addAction(self.action_btn2)

        self.edit_menu = self.menu_bar.addMenu("&Edit")
        self.edit_menu.addAction(self.action_btn2)
